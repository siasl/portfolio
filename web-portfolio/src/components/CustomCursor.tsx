...
const CustomCursor: React.FC = () => {
    ...
    // 1. Flip along vertical axis: scale(-0.1, -0.1) (Negate X of the original scale(0.1, -0.1))
    // 2. Align nose to cursor:
    //    - Assume nose is at (12800, 3200) in path coordinates.
    //    - Translate(-12800, -3200) moves nose to origin.
    //    - Scale and Rotate happens around origin (nose).
    //    - Translate(1600, 1600) moves nose to center of 3200x3200 viewBox.
    //    - Offset -30 centers the viewBox on the mouse.
    const offsetX = -30;
    const offsetY = -30;
    ...
    return (
        <motion.div
            ...
            transition={{ duration: 0 }} // Instant movement, no lag
        >
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="60px" height="60px" viewBox="0 0 3200 3200"
                preserveAspectRatio="xMidYMid meet">
                <metadata>
                    Created by potrace 1.15, written by Peter Selinger 2001-2017
                </metadata>
                <g transform="translate(1600,1600) rotate(45) scale(-0.100000,-0.100000) translate(-12800,-3200)"
